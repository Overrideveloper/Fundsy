            ...
            <div class="modal__card">
                ...
                <form class="modal__form" @submit.prevent="submit">
                    ...
                    <div class="modal__form__group">
                        ...
                        <input style="width:" name="withdrawal-cost" type="number" class="form__group__input" placeholder="0" :class="{ 'form__group__input-invalid': $v.withdrawalCost.$error }" v-model="$v.withdrawalCost.$model">
                    </div>
